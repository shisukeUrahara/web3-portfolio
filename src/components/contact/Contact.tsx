...
export const contacts: Contact[] = [
  {
    name: "EMAIL:",
    info: "abhisheksagu@gmail.com",
    icon: <MdOutlineEmail className="contact-icon" />,
    url: "mailto:abhisheksagu@gmail.com",
  },
  {
    name: "TWITTER:",
    info: "@ShisukeUrahara",
    icon: <AiFillTwitterCircle className="contact-icon" />,
    url: "https://twitter.com/ShisukeUrahara",
  },
  {
    name: "TELEGRAM:",
    info: "@Abhishek_Sagu",
    icon: <BsTelegram className="contact-icon" />,
    url: "https://t.me/Abhishek_Sagu",
  },
  {
    name: "DISCORD:",
    info: "ShisukeUrahara#4830",
    icon: <FaDiscord className="contact-icon" />,
    url: "https://discord.com/users/433293271121264640",
  },
  {
    name: "LINKED-IN:",
    info: "@Abhishek_Sagu",
    icon: <TiSocialLinkedin className="contact-icon" />,
    url: "https://www.linkedin.com/in/abhishek-sagu/",
  },
  {
    name: "GitHub:",
    info: "@shisukeUrahara",
    icon: <AiFillGithub className="contact-icon" />,
    url: "https://github.com/shisukeUrahara",
  },
];
